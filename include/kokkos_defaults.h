...
using ThreadExecPolicy =
    Kokkos::TeamPolicy<ExecSpace, Kokkos::LaunchBounds<128, 1>>;
using SimpleRange = Kokkos::RangePolicy<ExecSpace>;
#elif defined(MG_USE_HIP)
using ThreadExecPolicy =
    Kokkos::TeamPolicy<ExecSpace, Kokkos::LaunchBounds<256, 1>>;
using SimpleRange =
    Kokkos::RangePolicy<ExecSpace, Kokkos::LaunchBounds<256, 1>>;
#else
