...
TEST(TestKokkos, TestSpinProject) {
...

  {
    ...
    KokkosProjectLattice<MGComplex<REAL>, MGComplex<REAL>, 0, -1>(
        kokkos_in, kokkos_hspinor_out);
...

  {
    ...
    KokkosProjectLattice<MGComplex<REAL>, MGComplex<REAL>, 1, -1>(
        kokkos_in, kokkos_hspinor_out);
    KokkosCBSpinor2ToQDPLatticeHalfFermion(kokkos_hspinor_out, kokkos_out);
    qdp_out[rb[0]] -= kokkos_out;
...

  {
    ...
    KokkosProjectLattice<MGComplex<REAL>, MGComplex<REAL>, 2, -1>(
        kokkos_in, kokkos_hspinor_out);
    KokkosCBSpinor2ToQDPLatticeHalfFermion(kokkos_hspinor_out, kokkos_out);
    qdp_out[rb[0]] -= kokkos_out;
...

  {
    ...
    KokkosProjectLattice<MGComplex<REAL>, MGComplex<REAL>, 3, -1>(
        kokkos_in, kokkos_hspinor_out);
    KokkosCBSpinor2ToQDPLatticeHalfFermion(kokkos_hspinor_out, kokkos_out);
    qdp_out[rb[0]] -= kokkos_out;
...
TEST(TestKokkos, TestSpinProjectVec) {
...

  {
    ...
    KokkosProjectLattice<SIMDComplex<REAL32, V>, ThreadSIMDComplex<REAL32, V>,
                         0, -1>(kokkos_in, kokkos_hspinor_out);
    KokkosCBSpinor2ToQDPLatticeHalfFermion(kokkos_hspinor_out, kokkos_out);
    for (int v = 0; v < V; ++v) {
...
TEST(TestKokkos, TestSpinRecons) {
...

  {
    ...
    KokkosReconsLattice<MGComplex<REAL>, MGComplex<REAL>, 0, -1>(
        kokkos_hspinor_in, kokkos_spinor_out);
...

  {
    ...
    KokkosReconsLattice<MGComplex<REAL>, MGComplex<REAL>, 1, -1>(
        kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
...

  {
    ...
    KokkosReconsLattice<MGComplex<REAL>, MGComplex<REAL>, 2, -1>(
        kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
...

  {
    ...
    KokkosReconsLattice<MGComplex<REAL>, MGComplex<REAL>, 3, -1>(
        kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
...
TEST(TestKokkos, TestSpinReconsVec) {
...

  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 0,
                        -1>(kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
...

  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 1,
                        -1>(kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
  ...
  }
  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 2,
                        -1>(kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
  ...
  }
  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 3,
                        -1>(kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
...

  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 0, 1>(
        kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
...

  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 1, 1>(
        kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
  ...
  }
  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 2, 1>(
        kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
  ...
  }
  {
    ...
    KokkosReconsLattice<SIMDComplex<REAL, V>, ThreadSIMDComplex<REAL, V>, 3, 1>(
        kokkos_hspinor_in, kokkos_spinor_out);
    KokkosCBSpinorToQDPLatticeFermion(kokkos_spinor_out, kokkos_out);
...
TEST(TestKokkos, TestMultHalfSpinor) {
  ...
  MasterLog(INFO, "Testing MV");
  {
    ...
    KokkosMVLattice<GT, ST, TST>(kokkos_gauge_e, kokkos_hspinor_in, 0,
                                 kokkos_hspinor_out);
  ...
  // ********* TEST ADJOINT ****************
  {
    ...
    QDPLatticeHalfFermionToKokkosCBSpinor2(psi_in, kokkos_hspinor_in);
    KokkosHVLattice<GT, ST, TST>(kokkos_gauge_e, kokkos_hspinor_in, 0,
                                 kokkos_hspinor_out);
...
TEST(TestKokkos, TestDslash) {
  ...
  for (int cb = 0; cb < 2; ++cb) {
    KokkosCBFineSpinor<MGComplex<REAL>, 4>& out_spinor =
        (cb == EVEN) ? kokkos_spinor_even : kokkos_spinor_odd;
    KokkosCBFineSpinor<MGComplex<REAL>, 4>& in_spinor =
...
TEST(TestKokkos, TestDslashVec) {
  ...
  for (int per_team = 2; per_team < 4; per_team *= 2) {
    KokkosDslash<MGComplex<REAL>, SIMDComplex<REAL, VLen>,
                 ThreadSIMDComplex<REAL, VLen>>
        D(info, per_team);

    multi1d<LatticeFermion> psi_out(VLen);
    multi1d<LatticeFermion> kokkos_out(VLen);
    for (int cb = 0; cb < 2; ++cb) {
      KokkosCBFineSpinor<SIMDComplex<REAL, VLen>, 4>& out_spinor =
          (cb == EVEN) ? kokkos_spinor_even : kokkos_spinor_odd;
      KokkosCBFineSpinor<SIMDComplex<REAL, VLen>, 4>& in_spinor =
          (cb == EVEN) ? kokkos_spinor_odd : kokkos_spinor_even;
